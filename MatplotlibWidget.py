...
class MyMplCanvas(FigureCanvas):
    ...
    def Paint(self, title, X, Y, Z, xunit, yunit, colorbarTitle):
        ...
        # rect1 = patches.Rectangle((300, 300), 400, 400, linewidth=1, edgecolor='r', facecolor='none')
        # rect2 = patches.Rectangle((1300, 1300), 400, 400, linewidth=1, edgecolor='r', facecolor='none')
